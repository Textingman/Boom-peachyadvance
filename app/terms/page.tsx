    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/business" className="bg-[#FB923C] text-white hover:bg-[#F97316] px-4 py-2 rounded-md text-sm font-medium">
                  For Businesses
                </Link>
              </div>
            </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            The Service and all content, features, and functionality are owned by Peachy Verify and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and Peachy Verify regarding the Service and supersede all prior agreements.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-600 mb-2"><strong>Email:</strong> <a href="mailto:legal@peachyverify.com" className="text-[#FB923C] hover:text-[#F97316]">legal@peachyverify.com</a></p>
            <p className="text-gray-600 mb-2"><strong>Support:</strong> <a href="mailto:support@peachyverify.com" className="text-[#FB923C] hover:text-[#F97316]">support@peachyverify.com</a></p>
            <p className="text-gray-600"><strong>Website:</strong> <a href="/" className="text-[#FB923C] hover:text-[#F97316]">https://peachyverify.com</a></p>
          </div>
