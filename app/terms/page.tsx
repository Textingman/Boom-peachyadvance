      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            By accessing or using Peachy Advance's SMS verification service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service, including businesses, developers, and end users.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-gray-600 mb-6">
            Peachy Advance provides a carrier-compliant SMS verification platform that allows businesses to verify customer phone numbers through a secure, pass-through verification page. The Service includes:
          </p>
          ...
          <p className="text-gray-600 mb-6">
            The Service and all content, features, and functionality are owned by Peachy Advance and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            You agree to indemnify, defend, and hold harmless Peachy Advance and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
          ...
          <p className="text-gray-600 mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and Peachy Advance regarding the Service and supersede all prior agreements.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-600 mb-2"><strong>Email:</strong> <a href="mailto:legal@peachyadvance.com" className="text-[#FB923C] hover:text-[#F97316]">legal@peachyadvance.com</a></p>
            <p className="text-gray-600 mb-2"><strong>Support:</strong> <a href="mailto:support@peachyadvance.com" className="text-[#FB923C] hover:text-[#F97316]">support@peachyadvance.com</a></p>
            <p className="text-gray-600"><strong>Website:</strong> <a href="/" className="text-[#FB923C] hover:text-[#F97316]">https://peachyadvance.com</a></p>
          </div>
      ...
      <footer className="bg-[#3b3a41] text-white py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Peachy Advance</h3>
            ...
            <div>
              ...
              <p className="text-gray-400">
                support@peachyadvance.com
              </p>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Peachy Advance. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
